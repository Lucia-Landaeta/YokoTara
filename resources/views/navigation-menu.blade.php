...
@php
    $nav_links = [
        ['name' => 'Inicio', 'route' => route('home'), 'active' => request()->routeIs('home')],
        [
            'name' => 'Publicaciones',
...
<nav x-data="{ open: false }" class="w-full fixed top-0 z-50 bg-white border-b border-gray-100 shadow">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <div class="ml-3 relative">
                    ...
                    @else
                        <a href="{{ route('login') }}"
                            class="inline-flex items-center px-1 pt-1 text-sm font-bold leading-5 text-gray-600 hover:text-amber-600 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out">Iniciar
                            sesión</a>
                        <a href="{{ route('register') }}"
                            class="inline-flex items-center px-1 pt-1 text-sm font-bold leading-5 text-gray-600 hover:text-amber-600 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out">Registrarse</a>
                    @endauth
                </div>
            </div>
